...
func (a *ServerWithRoles) action(namespace string, resource string, action string) error {
	return utils.OpaqueAccessDenied(a.context.Checker.CheckAccessToRule(&auth.Context{User: a.context.User}, namespace, resource, action, false))
}
...
func (a *ServerWithRoles) hasLocalUserRole(checker auth.AccessChecker) bool {
...
func (a *ServerWithRoles) GetTokens(opts ...auth.MarshalOption) ([]services.ProvisionToken, error) {
