...
// authentication.go
type (
	AuthPreference       = types.AuthPreference       //nolint:golint
	AuthPreferenceV2     = types.AuthPreferenceV2     //nolint:golint
	AuthPreferenceSpecV2 = types.AuthPreferenceSpecV2 //nolint:golint
	U2F                  = types.U2F
)
